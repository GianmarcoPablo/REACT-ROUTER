...
const NuevoCliente = () => {
  ...
  return (
    <>
      ...
      <p className='mt-3'>Llena todos los campos para reguistrar un nuevo cliente</p>
      ...
      <div className="bg-white shadow rounded-md md:w-3/4 mx-auto px-5 py-10 mt-10">
        ...
        >
          ...
          <input
            type="submit"
            className="mt-5 w-full bg-blue-800 p-3 font-bold uppercase text-white text-lg"
